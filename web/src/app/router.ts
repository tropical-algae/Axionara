...
const routes = [
  ...
  { path: "/account", name: "account", component: () => import("@/pages/Account.vue"), meta: { auth: true, tone: "vault" } },
  ...
  { path: "/me", name: "me", component: () => import("@/pages/MeDashboard.vue"), meta: { auth: true, roles: ["consumer", "provider", "admin"], tone: "vault" } },
  { path: "/me/datasets/:id", name: "me-detail", component: () => import("@/pages/MeDatasetDetail.vue"), meta: { auth: true, roles: ["consumer", "provider", "admin"], tone: "vault", chat: "me-detail" } },
  { path: "/me/exports", name: "me-exports", component: () => import("@/pages/MeExports.vue"), meta: { auth: true, roles: ["consumer", "provider", "admin"], tone: "vault" } },
